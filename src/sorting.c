 ...
 */
int comparePlayercardForPreferedColorEmphasisAsc(PLAYERCARD *pc1, PLAYERCARD *pc2)
{
 ...
 */
int comparePlayercardForPreferedColorEmphasisDesc(PLAYERCARD *pc1, PLAYERCARD *pc2)
{
 ...
 */
PLAYERCARDCOMPARATOR* pccomparator_create(int (*compareFunction) (PLAYERCARD*,PLAYERCARD*))
{
    PLAYERCARDCOMPARATOR *newPlayerCardComparator;
    
    if ( (newPlayerCardComparator =(PLAYERCARDCOMPARATOR *) malloc(sizeof(PLAYERCARDCOMPARATOR))) == NULL)
 ...
 */
PLAYERCARDCOMPARATOR* pccomparator_createAndAppend(PLAYERCARDCOMPARATOR *prevComparator,int (*compareFunction) (PLAYERCARD*,PLAYERCARD*))
{
    PLAYERCARDCOMPARATOR *newPlayerCardComparator;
 ...
 */
void pccomparator_finalize(PLAYERCARDCOMPARATOR *aComparator)
{
 ...
 */
int pccomparator_compare(PLAYERCARDCOMPARATOR *aComparator, PLAYERCARD *aPlayerCard, PLAYERCARD *anotherPlayerCard)
{
...
PLAYERCARDCOMPARATOR* getStandardComparator(int id)
{
	switch (id)
	{
		case COMPARATOR_TABLE :
			...
			{
				standardComparator_table = pccomparator_create(comparePlayercardForPointsDesc);
		...
		case COMPARATOR_OUTPUT :
			if (standardComparator_output == NULL)
				standardComparator_output = pccomparator_create(comparePlayercardForIdAsc);
			return standardComparator_output;
		case COMPARATOR_GROUPSPLIT :
			if (standardComparator_groupsplit == NULL)
				standardComparator_groupsplit = pccomparator_create(comparePlayercardForPointsDesc);
			return standardComparator_groupsplit;
		case COMPARATOR_GROUP :
			if (standardComparator_group == NULL)
			{
				standardComparator_group = pccomparator_create(comparePlayercardForPointsDesc);
				pccomparator_createAndAppend(
					pccomparator_createAndAppend(
						pccomparator_createAndAppend(
		...
		case COMPARATOR_SUBGROUPSPLIT :
			...
			{
				standardComparator_subgroupsplit = pccomparator_create(comparePlayercardForPreferedColorAsc);
				pccomparator_createAndAppend(
					pccomparator_createAndAppend(
						pccomparator_createAndAppend(
							pccomparator_createAndAppend(
		...
		case COMPARATOR_TARGETQUALCHECK :
			...
			{
				standardComparator_targetqualcheck = pccomparator_create(comparePlayercardForPreferedColorDesc);
				pccomparator_createAndAppend(
					pccomparator_createAndAppend(
						pccomparator_createAndAppend(
							pccomparator_createAndAppend(
 ...
 */
void playerlist_bubblesort(PLAYERLIST *aPlayerList, PLAYERCARDCOMPARATOR *comparator)
{
    ...
    while(1)
    {
        ...
        cmp_result = pccomparator_compare(comparator,currEntry->aPlayerCard,currEntry->next->aPlayerCard);
        ...
        if ( cmp_result > 0 )
        {
            ...
            playercard_swap(&(currEntry->aPlayerCard),&(currEntry->next->aPlayerCard));
 ...
 */
void playerlist_sortWithStandardComparator(PLAYERLIST *aPlayerList, int comparator)
{
 ...
 */
void playerlist_sort(PLAYERLIST *aPlayerList, PLAYERCARDCOMPARATOR *comparator)
{
 ...
 */
int comparePlayerCardsWithStandardComparator(PLAYERCARD *aPlayerCard, PLAYERCARD *anotherPlayerCard,  int comparator)
{
    return pccomparator_compare(getStandardComparator(comparator) ,aPlayerCard, anotherPlayerCard);
}
...
void pairinglist_sort(PAIRINGLIST *aPairingList)
{
    ...
    while(1)
    {
        ...
        /* ein festgelegter ablauf von gestaffelten vergleichen, da ein comparator hier nicht
           anwendbar ist (die zu vergleichenden objekte sind keine playerListEntries)*/
        cmp_result = comparePlayercardForPointsDesc(
		        currEntry->player1->points > currEntry->player2->points ? currEntry->player1 : currEntry->player2,
		        currEntry->next->player1->points > currEntry->next->player2->points ? currEntry->next->player1 : currEntry->next->player2
        		);
        if (cmp_result == 0)
        {
        	cmp_result = comparePlayercardForPointsDesc(
        ...
        if (cmp_result == 0)
        {
        	cmp_result = comparePlayerCardsWithStandardComparator(
        			comparePlayerCardsWithStandardComparator(currEntry->player1,currEntry->player2,COMPARATOR_GROUP) > 0 ? currEntry->player2 : currEntry->player1,
        			comparePlayerCardsWithStandardComparator(currEntry->next->player1,currEntry->next->player2,COMPARATOR_GROUP) > 0 ? currEntry->next->player2 : currEntry->next->player1,
        			COMPARATOR_GROUP
        	     );
        }
