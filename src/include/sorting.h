 ...
 * Spieler mit groesserer Wertung sind "kleiner"
 */
extern int comparePlayercardForBuchholzsumDesc(PLAYERCARD *pc1, PLAYERCARD *pc2);

/** 
 * Vergleichsfunktion fuer zwei spieler nach buchholzsummenwertung,
 * Spieler mit groesserer Wertung sind "groesser"
 */
extern int comparePlayercardForBuchholzsumAsc(PLAYERCARD *pc1, PLAYERCARD *pc2);
 ...
 * Spieler mit weiss sind "kleiner"
 */
extern int comparePlayercardForPreferedColorAsc(PLAYERCARD *pc1, PLAYERCARD *pc2);

/** 
 * Vergleichsfunktion fuer zwei spieler nach Sollfarbe,
 * Spieler mit weiss sind "groesser"
 */
extern int comparePlayercardForPreferedColorDesc(PLAYERCARD *pc1, PLAYERCARD *pc2);

/** 
 * Vergleichsfunktion fuer zwei spieler nach Gewichtung der Sollfarbe
 */
extern int comparePlayercardForPreferedColorEmphasisAsc(PLAYERCARD *pc1, PLAYERCARD *pc2);

/** 
 * Vergleichsfunktion fuer zwei spieler nach Gewichtung der Sollfarbe ungekehrt
 */
extern int comparePlayercardForPreferedColorEmphasisDesc(PLAYERCARD *pc1, PLAYERCARD *pc2);
 ...
 */
extern void playerlist_sortWithStandardComparator(PLAYERLIST *aPlayerList, int comparator);

/**
 * Sortierung einer spielerliste
 */
extern void playerlist_sort(PLAYERLIST *aPlayerList, PLAYERCARDCOMPARATOR *comparator);

/**
 * Vergleicht 2 Spielerkarten mit einer Standard-Vergleichsfunktion
 */
extern int comparePlayerCardsWithStandardComparator(PLAYERCARD *aPlayerCard, PLAYERCARD *anotherPlayerCard,  int comparator);
